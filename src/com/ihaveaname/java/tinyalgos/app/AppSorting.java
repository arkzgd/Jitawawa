...
public class AppSorting {
  public static void main(String[] args) {
    ...
    assert checkAscendingOrder(bubbleSort(input, Integer::compareTo), Integer::compareTo);
    assert checkAscendingOrder(combSort(input, Integer::compareTo), Integer::compareTo);
    assert insertSort(input, Integer::compareTo).size() == input.size();
    assert checkAscendingOrder(insertSort(input, Integer::compareTo), Integer::compareTo);
    ...
    assert insertSort(input, String::compareTo).size() == input.size();
    assert checkAscendingOrder(insertSort(input, String::compareTo), String::compareTo);
  }
}
